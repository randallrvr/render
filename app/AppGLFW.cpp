...
//Constructor*******************************************************************
//******************************************************************************
AppGLFW::AppGLFW(const string &title, int width, int height, bool resizable)
{
...
//System Initialize*************************************************************
//******************************************************************************
void AppGLFW::system_init(const char *name, unsigned int width, unsigned int height)
{
	if (!glfwInit())
		exit(1);
...
//Set Window Title**************************************************************
//******************************************************************************
void AppGLFW::system_title(const string &title)
{
...
//******************************************************************************
bool AppGLFW::keyDown(Key key) const
{
	return curr_keyState[(int)key];
}
//-----------------------------------------------------------------------------
bool AppGLFW::keyUp(Key key) const
{
	return !curr_keyState[(int)key];
}
//-----------------------------------------------------------------------------
bool AppGLFW::keyPressed(Key key) const
{
	return curr_keyState[(int)key] && !prev_keyState[(int)key];
}
//-----------------------------------------------------------------------------
bool AppGLFW::keyReleased(Key key) const
{
	return !curr_keyState[(int)key] && prev_keyState[(int)key];
}
//******************************************************************************
...
//******************************************************************************
bool AppGLFW::mouseDown(MouseButton button) const
{
	return curr_mouseState[(int)button];
}
//-----------------------------------------------------------------------------
bool AppGLFW::mouseUp(MouseButton button) const
{
	return !curr_mouseState[(int)button];
}
//-----------------------------------------------------------------------------
bool AppGLFW::mousePressed(MouseButton button) const
{
	return curr_mouseState[(int)button] && !prev_keyState[(int)button];
}
//-----------------------------------------------------------------------------
bool AppGLFW::mouseReleased(MouseButton button) const
{
	return !curr_mouseState[(int)button] && prev_keyState[(int)button];
}